...
module vga_display (
    ...
    // Map signed [-255 to 255] to unsigned grayscale [0 to 255]
    wire [7:0] mapped_color = 8'd128 + (dog_pixel >>> 1);
        ...
        if (ce) begin
            if (video_on_delay) begin
                if (in_box_delay) begin
                    ...
                    // Dark blue background outside the image
                    vga_r <= 4'h0;
                    vga_g <= 4'h0;
                    vga_b <= 4'h2;
                end
